...
runQAQC=function(data){
    ...
    h+='<tr><th style="color:blue">Constraints</th></tr>'
    upset.data.parms.forEach((s,i)=>{
        h+=`<tr><td style="color:green">${i+1}.<input type='checkbox' id="${s}_parm" onchange="upset.check('${s}');upset.count()">${s} (<span id="${s}_count" style="color:gray"></span>); </td></tr>`
    })
    h+='</table>'
    /////////////////
    h+='<hr>'
