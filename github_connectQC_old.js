...
proj3.innerHTML += '<input type="text" id="sql" name="sql"> Include both asterisks! (ie. SELECT * FROM SELECT * FROM `nih-nci-dceg-connect-dev.recruitment.recruitment1_WL` )<br>'
